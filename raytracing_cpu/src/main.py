...
# 1. Ventana
window = Window(WIDTH, HEIGHT, "Raytracer por CPU")
...
# 5. Cámara y Escena
camera = Camera((0, 0, 20), (0, 0, 0), (0, 1, 0), 45, window.width / window.height, 0.1, 100.0)
scene = RayScene(window.ctx, camera, WIDTH, HEIGHT)

# 6. Añadir objetos a la escena
