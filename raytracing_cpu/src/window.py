...
class Window(pyglet.window.Window):
    ...
    def set_scene(self, scene):
        """
        Asigna una escena a la ventana y llama a su método de inicio.
        Esta es la implementación directa de la guía.
        """
        self.scene = scene
        self.scene.start()
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        """
        # Solo procesa el clic si hay una escena y si esa escena puede manejar clics.
    ...
    def on_resize(self, width, height):
        ...
        # Delega la lógica de redimensionado a la escena para que ajuste la cámara y el viewport.
