...
# La clase ImageData no tiene atributos privados, no cambia.
class ImageData:
    """Contenedor para los píxeles de una imagen en la memoria de la CPU."""
...
class Texture:
    """Encapsula la información de una textura."""
